...
<template>
    <div class="relative overflow-hidden rounded-[2rem] border border-heritage-gold/30 bg-linear-to-br from-white via-heritage-gold-faint to-heritage-red-faint p-4 shadow-card">
        <div class="absolute left-5 top-5 z-10 rounded-full bg-white/85 px-3 py-2 text-xs font-black uppercase tracking-wide text-heritage-gold-deep shadow-card">
        ...
        <div class="relative aspect-[1.55/1] overflow-hidden rounded-[1.5rem] bg-heritage-panel">
            ...
            <div class="absolute h-0 w-0 -translate-x-1/2 -translate-y-1/2" :style="markerStyle">
                ...
                <span v-if="showLabel && label" class="absolute left-6 top-1 whitespace-nowrap rounded-full bg-white px-3 py-2 text-xs font-black text-heritage-ink shadow-card">
                    {{ label }}
                </span>
            </div>
        </div>
