...
<template>
    <DashboardLayout>
        <section class="mb-10 grid gap-6 md:grid-cols-[1.4fr_0.6fr] md:items-center">
            <div>
                ...
                <p class="mt-3 max-w-2xl text-lg text-heritage-muted">Track category mastery, quiz history, badges, and score trends across the MakedonIQ learning path.</p>
            </div>
        ...
        <section class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <article v-for="category in progressCategories" :key="category.title" class="soft-card p-6">
                <div class="mb-5 flex items-center justify-between">
                    ...
                    <span class="flex h-12 w-12 items-center justify-center rounded-2xl bg-heritage-panel text-lg font-black text-heritage-red">{{ category.icon }}</span>
                </div>
            ...
            <aside class="space-y-8">
                <article class="soft-card p-6">
                    ...
                    <div class="mt-5 grid gap-3">
                        <div v-for="achievement in achievements" :key="achievement.title" class="flex gap-4 rounded-2xl bg-heritage-panel p-4">
                            <span class="flex h-11 w-11 items-center justify-center rounded-2xl bg-heritage-gold-soft font-black text-heritage-gold-deep">{{ achievement.icon }}</span>
                            <div>
                ...
                <article class="soft-card p-6">
                    ...
                    <div class="mt-5 grid grid-cols-2 gap-3">
                        <div class="rounded-2xl bg-heritage-red-soft p-4">
